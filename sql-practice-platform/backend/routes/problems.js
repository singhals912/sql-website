...
// Import complete database from local export
router.post('/import-local-complete', async (req, res) => {
    try {
        console.log('🚀 Starting complete database import from local export...');
        
        // Use the export data embedded here since file might not be accessible
        const exportData = require('../problems-export-2025-08-25.json');
        ...
        res.json({
            success: true,
            message: 'Complete database import from local successful',
            stats: {
