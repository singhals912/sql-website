...
try {
  app.use('/api/urgent-1-3', require('./routes/urgent-1-3-fix'));
  console.log('✅ Urgent 1-3 Fix route loaded');
} catch (e) {
  console.error('❌ Urgent 1-3 Fix route failed:', e.message);
}

try {
  app.use('/api/batch-2', require('./routes/batch-2-problems-11-20'));
  console.log('✅ Batch 2 Problems 11-20 route loaded');
} catch (e) {
  console.error('❌ Batch 2 Problems 11-20 route failed:', e.message);
}

try {
  app.use('/api/batch-3', require('./routes/batch-3-problems-21-30'));
  console.log('✅ Batch 3 Problems 21-30 route loaded');
} catch (e) {
  console.error('❌ Batch 3 Problems 21-30 route failed:', e.message);
}

try {
  app.use('/api/batch-4', require('./routes/batch-4-problems-31-40'));
  console.log('✅ Batch 4 Problems 31-40 route loaded');
} catch (e) {
  console.error('❌ Batch 4 Problems 31-40 route failed:', e.message);
}

try {
  app.use('/api/batch-5', require('./routes/batch-5-problems-41-50'));
  console.log('✅ Batch 5 Problems 41-50 route loaded');
} catch (e) {
...
try {
  app.use('/api/batch-7', require('./routes/batch-7-problems-61-70'));
  console.log('✅ Batch 7 Problems 61-70 route loaded');
} catch (e) {
