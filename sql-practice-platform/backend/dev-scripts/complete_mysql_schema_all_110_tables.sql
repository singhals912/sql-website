[dotenv@17.2.1] injecting env (20) from .env -- tip: ⚙️  write to custom object with { processEnv: myObject }
[dotenv@17.2.1] injecting env (0) from .env -- tip: 📡 auto-backup env with Radar: https://dotenvx.com/radar
🔍 Starting comprehensive table audit...

Connected to PostgreSQL database
📊 Found 70 total problems in database
📊 Active problems: 70
📊 Inactive problems: 0

📊 Found 70 total schemas across all problems

📊 PostgreSQL schemas: 70
📊 MySQL schemas: 0

🔍 Processing: Subscription Business Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Snapchat Social Media Engagement (postgresql) - Problem ACTIVE
🔍 Processing: Goldman Sachs Prime Brokerage Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Salesforce Customer Success Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Supply Chain Optimization (postgresql) - Problem ACTIVE
🔍 Processing: American Express Credit Portfolio Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Morgan Stanley Institutional Securities Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Uber Ride-Sharing Market Analytics (postgresql) - Problem ACTIVE
🔍 Processing: UBS Wealth Management Private Banking (postgresql) - Problem ACTIVE
🔍 Processing: Credit Suisse Investment Banking M&A (postgresql) - Problem ACTIVE
🔍 Processing: Employee Performance Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Product Inventory Status (postgresql) - Problem ACTIVE
🔍 Processing: UBS Wealth Management Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Walmart Supply Chain Efficiency Analytics (postgresql) - Problem ACTIVE
🔍 Processing: LinkedIn Professional Network Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Amazon Prime Video Content Performance (postgresql) - Problem ACTIVE
🔍 Processing: Hospital Patient Care Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Movie Recommendation Engine (postgresql) - Problem ACTIVE
🔍 Processing: Credit Suisse Private Banking Analytics (postgresql) - Problem ACTIVE
🔍 Processing: User Engagement Metrics (postgresql) - Problem ACTIVE
🔍 Processing: PayPal Digital Payments Analytics (postgresql) - Problem ACTIVE
🔍 Processing: AIG Insurance Claims Fraud Detection (postgresql) - Problem ACTIVE
🔍 Processing: Mastercard Global Payment Network Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Citadel Hedge Fund Risk Parity Analysis (postgresql) - Problem ACTIVE
🔍 Processing: Tesla Energy Storage Analytics (postgresql) - Problem ACTIVE
🔍 Processing: AT&T Customer Service Call Volume Analytics (postgresql) - Problem ACTIVE
🔍 Processing: HSBC Trade Finance Analytics (postgresql) - Problem ACTIVE
🔍 Processing: A/B Test Results Analysis (postgresql) - Problem ACTIVE
🔍 Processing: Apple App Store Revenue Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Renaissance Technologies Quantitative Alpha (postgresql) - Problem ACTIVE
🔍 Processing: E-commerce Customer Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Manufacturing Quality Control Analysis (postgresql) - Problem ACTIVE
🔍 Processing: Session Duration Analysis (postgresql) - Problem ACTIVE
🔍 Processing: Energy Consumption Analysis (postgresql) - Problem ACTIVE
🔍 Processing: Salesforce CRM Performance Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Fidelity Investment Portfolio Optimization (postgresql) - Problem ACTIVE
🔍 Processing: UnitedHealth Claims Processing Efficiency (postgresql) - Problem ACTIVE
🔍 Processing: Supply Chain Logistics Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Visa Global Payment Processing Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Inventory Management System (postgresql) - Problem ACTIVE
🔍 Processing: Verizon Network Coverage Analysis (postgresql) - Problem ACTIVE
🔍 Processing: Charles Schwab Wealth Management Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Social Media Engagement Analysis (postgresql) - Problem ACTIVE
🔍 Processing: Oracle Enterprise Software Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Wells Fargo Mortgage Risk Assessment (postgresql) - Problem ACTIVE
🔍 Processing: Financial Portfolio Performance Analysis (postgresql) - Problem ACTIVE
🔍 Processing: Real Estate Market Analysis (postgresql) - Problem ACTIVE
🔍 Processing: Adobe Creative Cloud Subscription Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Digital Marketing Campaign Performance (postgresql) - Problem ACTIVE
🔍 Processing: Customer Service Analytics Dashboard (postgresql) - Problem ACTIVE
🔍 Processing: BBVA Digital Banking Transformation Analytics (postgresql) - Problem ACTIVE
🔍 Processing: JPMorgan Derivatives Risk Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Netflix Content Strategy Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Citigroup Global Investment Banking Analytics (postgresql) - Problem ACTIVE
🔍 Processing: BlackRock Alternative Investment Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Costco Wholesale Membership Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Intel Semiconductor Manufacturing Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Wells Fargo Commercial Banking Analytics (postgresql) - Problem ACTIVE
🔍 Processing: ING Sustainable Finance Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Top Spending Customers by Month (postgresql) - Problem ACTIVE
🔍 Processing: ABN AMRO Corporate Banking Risk Analytics (postgresql) - Problem ACTIVE
🔍 Processing: BNP Paribas Investment Banking Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Target Store Revenue by Category (postgresql) - Problem ACTIVE
🔍 Processing: Vanguard Index Fund Performance Analytics (postgresql) - Problem ACTIVE
🔍 Processing: McKinsey Client Engagement Analysis (postgresql) - Problem ACTIVE
🔍 Processing: Restaurant Chain Sales Analysis (postgresql) - Problem ACTIVE
🔍 Processing: Deutsche Bank Credit Risk Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Pinterest Content Engagement Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Online Learning Platform Analytics (postgresql) - Problem ACTIVE
🔍 Processing: Goldman Sachs Algorithmic Trading Performance (postgresql) - Problem ACTIVE

🎯 COMPREHENSIVE TABLE AUDIT RESULTS
=====================================
📊 Total unique tables found: 110
...
🔹 Table: AB_TEST_RESULTS
   ...
   Active problems: 1
   Inactive problems: 0
   Used in: A/B Test Results Analysis (active)

🔹 Table: ADOBE_SUBSCRIPTIONS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Adobe Creative Cloud Subscription Analytics (active)

🔹 Table: AGGREGATED_METRICS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: BNP Paribas Investment Banking Analytics (active)

🔹 Table: AGGREGATED_WEALTH
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Credit Suisse Private Banking Analytics (active)

🔹 Table: AIG_POLICIES
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: AIG Insurance Claims Fraud Detection (active)

🔹 Table: AMAZON_PRIME_SUBSCRIBERS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Amazon Prime Video Content Performance (active)

🔹 Table: AMEX_CREDIT_PORTFOLIO
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: American Express Credit Portfolio Analytics (active)

🔹 Table: APPSTORE_REVENUE
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Apple App Store Revenue Analytics (active)

🔹 Table: ASSET_CLASSES
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Financial Portfolio Performance Analysis (active)

🔹 Table: ATT_SERVICE_CALLS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: AT&T Customer Service Call Volume Analytics (active)

🔹 Table: BANKING_METRICS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Wells Fargo Commercial Banking Analytics (active)

🔹 Table: BANKING_PERFORMANCE
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: BNP Paribas Investment Banking Analytics (active)

🔹 Table: BBVA_DIGITAL_BANKING
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: BBVA Digital Banking Transformation Analytics (active)

🔹 Table: BLACKROCK_ALTERNATIVES
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: BlackRock Alternative Investment Analytics (active)

🔹 Table: BNPPARIBAS_INVESTMENT_BANKING
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: BNP Paribas Investment Banking Analytics (active)
...
🔹 Table: CAMPAIGN_RESULTS
   ...
   Active problems: 1
   Inactive problems: 0
   Used in: Digital Marketing Campaign Performance (active)
...
🔹 Table: CITADEL_POSITIONS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Citadel Hedge Fund Risk Parity Analysis (active)

🔹 Table: CITIGROUP_INVESTMENT_BANKING
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Citigroup Global Investment Banking Analytics (active)

🔹 Table: CLIENT_ENGAGEMENTS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: McKinsey Client Engagement Analysis (active)

🔹 Table: CORPORATE_RISK_PROFILES
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: ABN AMRO Corporate Banking Risk Analytics (active)

🔹 Table: COSTCO_MEMBERSHIPS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Costco Wholesale Membership Analytics (active)

🔹 Table: COURSES
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Online Learning Platform Analytics (active)

🔹 Table: CREDITSUISSE_MA_DEALS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Credit Suisse Investment Banking M&A (active)

🔹 Table: CREDITSUISSE_PRIVATE_BANKING
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Credit Suisse Private Banking Analytics (active)
...
🔹 Table: CUSTOMERS
   ...
   Active problems: 2
   Inactive problems: 0
   Used in: Subscription Business Analytics (active), E-commerce Customer Analytics (active)

🔹 Table: DECILE_ANALYSIS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Wells Fargo Mortgage Risk Assessment (active)

🔹 Table: DELIVERIES
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Supply Chain Logistics Analytics (active)
...
🔹 Table: DEPARTMENTS
   ...
   Active problems: 2
   Inactive problems: 0
   Used in: Employee Performance Analytics (active), Hospital Patient Care Analytics (active)

🔹 Table: DEUTSCHEBANK_CREDIT_PORTFOLIO
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Deutsche Bank Credit Risk Analytics (active)
...
🔹 Table: DISTRIBUTION_CENTERS
   ...
   Active problems: 2
   Inactive problems: 0
   Used in: Walmart Supply Chain Efficiency Analytics (active), Supply Chain Logistics Analytics (active)

🔹 Table: EFFICIENCY_METRICS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Energy Consumption Analysis (active)

🔹 Table: EMPLOYEES
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Employee Performance Analytics (active)
...
🔹 Table: FIDELITY_PORTFOLIO_OPTIMIZATION
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Fidelity Investment Portfolio Optimization (active)
...
🔹 Table: GOLDMANSACHS_ALGO_TRADING
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Goldman Sachs Algorithmic Trading Performance (active)

🔹 Table: GOLDMANSACHS_PRIME_BROKERAGE
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Goldman Sachs Prime Brokerage Analytics (active)

🔹 Table: ING_SUSTAINABLE_FINANCE
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: ING Sustainable Finance Analytics (active)

🔹 Table: INTEL_MANUFACTURING
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Intel Semiconductor Manufacturing Analytics (active)

🔹 Table: INVENTORY
   Total references: 2
   Active problems: 2
   Inactive problems: 0
   Used in: Product Inventory Status (active), Inventory Management System (active)

🔹 Table: JPMORGAN_DERIVATIVES
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: JPMorgan Derivatives Risk Analytics (active)

🔹 Table: LINKEDIN_ENGAGEMENT
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: LinkedIn Professional Network Analytics (active)
...
🔹 Table: MASTERCARD_NETWORK
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Mastercard Global Payment Network Analytics (active)

🔹 Table: MENU_ITEMS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Restaurant Chain Sales Analysis (active)
...
🔹 Table: MONTHLY_SPENDING
   ...
   Active problems: 1
   Inactive problems: 0
   Used in: Top Spending Customers by Month (active)

🔹 Table: MORGANSTANLEY_INSTITUTIONAL_SECURITIES
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Morgan Stanley Institutional Securities Analytics (active)

🔹 Table: MOVIES
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Movie Recommendation Engine (active)

🔹 Table: NEIGHBORHOODS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Real Estate Market Analysis (active)

🔹 Table: NETFLIX_CONTENT_STRATEGY
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Netflix Content Strategy Analytics (active)

🔹 Table: NETWORK_TOWERS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Verizon Network Coverage Analysis (active)

🔹 Table: ORACLE_ENTERPRISE_SOFTWARE
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Oracle Enterprise Software Analytics (active)

🔹 Table: ORDERS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: E-commerce Customer Analytics (active)

🔹 Table: PATIENTS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Hospital Patient Care Analytics (active)

🔹 Table: PAYPAL_TRANSACTIONS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: PayPal Digital Payments Analytics (active)
...
🔹 Table: PINTEREST_CONTENT
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Pinterest Content Engagement Analytics (active)
...
🔹 Table: POSTS
   ...
   Active problems: 2
   Inactive problems: 0
   Used in: User Engagement Metrics (active), Social Media Engagement Analysis (active)

🔹 Table: PRODUCTION_LINES
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Manufacturing Quality Control Analysis (active)

🔹 Table: PRODUCTS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Inventory Management System (active)
...
🔹 Table: RANKED_CUSTOMERS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Top Spending Customers by Month (active)

🔹 Table: RENAISSANCE_STRATEGIES
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Renaissance Technologies Quantitative Alpha (active)
...
🔹 Table: SALESFORCE_CUSTOMER_SUCCESS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Salesforce Customer Success Analytics (active)

🔹 Table: SALESFORCE_USAGE
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Salesforce CRM Performance Analytics (active)

🔹 Table: SCHWAB_WEALTH_MANAGEMENT
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Charles Schwab Wealth Management Analytics (active)

🔹 Table: SECTOR_RISK_METRICS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Deutsche Bank Credit Risk Analytics (active)

🔹 Table: SNAPCHAT_ENGAGEMENT
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Snapchat Social Media Engagement (active)
...
🔹 Table: SUBSCRIPTION_PLANS
   ...
   Active problems: 1
   Inactive problems: 0
   Used in: Subscription Business Analytics (active)
...
🔹 Table: SUPPORT_AGENTS
   ...
   Active problems: 1
   Inactive problems: 0
   Used in: Customer Service Analytics Dashboard (active)
...
🔹 Table: TARGET_SALES
   ...
   Active problems: 1
   Inactive problems: 0
   Used in: Target Store Revenue by Category (active)

🔹 Table: TESLA_ENERGY_STORAGE
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Tesla Energy Storage Analytics (active)
...
🔹 Table: TRADE_TRANSACTIONS
   ...
   Active problems: 1
   Inactive problems: 0
   Used in: HSBC Trade Finance Analytics (active)
...
🔹 Table: UBER_MARKET_PERFORMANCE
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Uber Ride-Sharing Market Analytics (active)

🔹 Table: UBS_PRIVATE_BANKING
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: UBS Wealth Management Private Banking (active)

🔹 Table: UBS_WEALTH_MANAGEMENT
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: UBS Wealth Management Analytics (active)

🔹 Table: UNITEDHEALTH_CLAIMS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: UnitedHealth Claims Processing Efficiency (active)

🔹 Table: USER_SESSIONS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Session Duration Analysis (active)

🔹 Table: USERS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Social Media Engagement Analysis (active)

🔹 Table: VANGUARD_FUNDS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Vanguard Index Fund Performance Analytics (active)

🔹 Table: VISA_TRANSACTIONS
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Visa Global Payment Processing Analytics (active)

🔹 Table: WAREHOUSE_INVENTORY
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Supply Chain Optimization (active)

🔹 Table: WEALTH_PERFORMANCE
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Credit Suisse Private Banking Analytics (active)

🔹 Table: WELLSFARGO_COMMERCIAL_BANKING
   Total references: 1
   Active problems: 1
   Inactive problems: 0
   Used in: Wells Fargo Commercial Banking Analytics (active)
...
-- Generated: 2025-08-23T12:39:28.077Z
-- Total Tables: 110
-- ============================================

-- Drop existing tables (in dependency order)
DROP TABLE IF EXISTS wf_borrowers;
DROP TABLE IF EXISTS wellsfargo_commercial_banking;
DROP TABLE IF EXISTS wealth_performance;
DROP TABLE IF EXISTS warehouse_inventory;
DROP TABLE IF EXISTS visa_transactions;
DROP TABLE IF EXISTS vanguard_funds;
DROP TABLE IF EXISTS users;
DROP TABLE IF EXISTS user_sessions;
DROP TABLE IF EXISTS unitedhealth_claims;
DROP TABLE IF EXISTS ubs_wealth_management;
DROP TABLE IF EXISTS ubs_private_banking;
DROP TABLE IF EXISTS uber_market_performance;
DROP TABLE IF EXISTS transactions;
DROP TABLE IF EXISTS trade_transactions;
DROP TABLE IF EXISTS total_risk;
DROP TABLE IF EXISTS tesla_energy_storage;
...
DROP TABLE IF EXISTS solar_installations;
DROP TABLE IF EXISTS snapchat_engagement;
DROP TABLE IF EXISTS sector_risk_metrics;
DROP TABLE IF EXISTS schwab_wealth_management;
DROP TABLE IF EXISTS salesforce_usage;
DROP TABLE IF EXISTS salesforce_customer_success;
DROP TABLE IF EXISTS sales;
DROP TABLE IF EXISTS risk_deciles;
DROP TABLE IF EXISTS risk_contributions;
DROP TABLE IF EXISTS risk_calculations;
DROP TABLE IF EXISTS risk_analysis;
DROP TABLE IF EXISTS restaurants;
DROP TABLE IF EXISTS renaissance_strategies;
DROP TABLE IF EXISTS ranked_customers;
...
DROP TABLE IF EXISTS pinterest_content;
DROP TABLE IF EXISTS performance_metrics;
DROP TABLE IF EXISTS paypal_transactions;
DROP TABLE IF EXISTS patients;
DROP TABLE IF EXISTS orders;
DROP TABLE IF EXISTS oracle_enterprise_software;
DROP TABLE IF EXISTS network_towers;
DROP TABLE IF EXISTS netflix_content_strategy;
DROP TABLE IF EXISTS neighborhoods;
DROP TABLE IF EXISTS movies;
DROP TABLE IF EXISTS morganstanley_institutional_securities;
DROP TABLE IF EXISTS monthly_spending;
DROP TABLE IF EXISTS metrics;
DROP TABLE IF EXISTS menu_items;
DROP TABLE IF EXISTS mastercard_network;
DROP TABLE IF EXISTS marketing_channels;
DROP TABLE IF EXISTS ma_metrics;
DROP TABLE IF EXISTS linkedin_engagement;
DROP TABLE IF EXISTS jpmorgan_derivatives;
DROP TABLE IF EXISTS inventory;
DROP TABLE IF EXISTS intel_manufacturing;
DROP TABLE IF EXISTS ing_sustainable_finance;
DROP TABLE IF EXISTS goldmansachs_prime_brokerage;
DROP TABLE IF EXISTS goldmansachs_algo_trading;
DROP TABLE IF EXISTS generate_series;
DROP TABLE IF EXISTS fidelity_portfolio_optimization;
DROP TABLE IF EXISTS enrollments;
DROP TABLE IF EXISTS employees;
DROP TABLE IF EXISTS efficiency_metrics;
DROP TABLE IF EXISTS distribution_centers;
DROP TABLE IF EXISTS digital_metrics;
DROP TABLE IF EXISTS deutschebank_credit_portfolio;
DROP TABLE IF EXISTS departments;
DROP TABLE IF EXISTS delivery_routes;
DROP TABLE IF EXISTS deliveries;
DROP TABLE IF EXISTS decile_analysis;
DROP TABLE IF EXISTS customers;
DROP TABLE IF EXISTS creditsuisse_private_banking;
DROP TABLE IF EXISTS creditsuisse_ma_deals;
DROP TABLE IF EXISTS courses;
DROP TABLE IF EXISTS costco_memberships;
DROP TABLE IF EXISTS corporate_risk_profiles;
DROP TABLE IF EXISTS client_engagements;
DROP TABLE IF EXISTS citigroup_investment_banking;
DROP TABLE IF EXISTS citadel_positions;
DROP TABLE IF EXISTS campaigns;
DROP TABLE IF EXISTS campaign_results;
DROP TABLE IF EXISTS call_stats;
DROP TABLE IF EXISTS bnpparibas_investment_banking;
DROP TABLE IF EXISTS blackrock_alternatives;
DROP TABLE IF EXISTS bbva_digital_banking;
DROP TABLE IF EXISTS banking_performance;
DROP TABLE IF EXISTS banking_metrics;
DROP TABLE IF EXISTS att_service_calls;
DROP TABLE IF EXISTS asset_classes;
DROP TABLE IF EXISTS appstore_revenue;
DROP TABLE IF EXISTS amex_credit_portfolio;
DROP TABLE IF EXISTS amazon_prime_subscribers;
DROP TABLE IF EXISTS aig_policies;
DROP TABLE IF EXISTS aggregated_wealth;
DROP TABLE IF EXISTS aggregated_metrics;
DROP TABLE IF EXISTS adobe_subscriptions;
...
-- Table: AB_TEST_RESULTS
-- ============================================
-- Source: A/B Test Results Analysis (postgresql)
...
-- Sample data for ab_test_results
...
-- Table: ADOBE_SUBSCRIPTIONS
-- ============================================
-- Source: Adobe Creative Cloud Subscription Analytics (postgresql)
...
-- Sample data for adobe_subscriptions
...
-- Table: AGGREGATED_METRICS
-- ============================================
-- WARNING: No CREATE statement found for aggregated_metrics
-- This table was referenced but not defined

-- ============================================
-- Table: AGGREGATED_WEALTH
-- ============================================
-- WARNING: No CREATE statement found for aggregated_wealth
-- This table was referenced but not defined

-- ============================================
-- Table: AIG_POLICIES
-- ============================================
-- Source: AIG Insurance Claims Fraud Detection (postgresql)
...
-- Table: AMAZON_PRIME_SUBSCRIBERS
-- ============================================
-- Source: Amazon Prime Video Content Performance (postgresql)
...
-- Sample data for amazon_prime_subscribers
...
-- Table: AMEX_CREDIT_PORTFOLIO
-- ============================================
-- Source: American Express Credit Portfolio Analytics (postgresql)
...
-- Sample data for amex_credit_portfolio
...
-- Table: APPSTORE_REVENUE
-- ============================================
-- Source: Apple App Store Revenue Analytics (postgresql)
...
-- Sample data for appstore_revenue
...
-- Table: ASSET_CLASSES
-- ============================================
-- Source: Financial Portfolio Performance Analysis (postgresql)
...
-- Table: ATT_SERVICE_CALLS
-- ============================================
-- Source: AT&T Customer Service Call Volume Analytics (postgresql)
...
-- Sample data for att_service_calls
...
-- Table: BANKING_METRICS
-- ============================================
-- WARNING: No CREATE statement found for banking_metrics
-- This table was referenced but not defined

-- ============================================
-- Table: BANKING_PERFORMANCE
-- ============================================
-- WARNING: No CREATE statement found for banking_performance
-- This table was referenced but not defined

-- ============================================
-- Table: BBVA_DIGITAL_BANKING
-- ============================================
-- Source: BBVA Digital Banking Transformation Analytics (postgresql)
...
-- Sample data for bbva_digital_banking
...
-- Table: BLACKROCK_ALTERNATIVES
-- ============================================
-- Source: BlackRock Alternative Investment Analytics (postgresql)
...
-- Sample data for blackrock_alternatives
...
-- Table: BNPPARIBAS_INVESTMENT_BANKING
-- ============================================
-- Source: BNP Paribas Investment Banking Analytics (postgresql)
...
-- Sample data for bnpparibas_investment_banking
...
-- Table: CALL_STATS
-- ============================================
-- WARNING: No CREATE statement found for call_stats
-- This table was referenced but not defined

-- ============================================
-- Table: CAMPAIGN_RESULTS
-- ============================================
-- Source: Digital Marketing Campaign Performance (postgresql)
...
-- Sample data for campaign_results
...
-- Table: CITADEL_POSITIONS
-- ============================================
-- Source: Citadel Hedge Fund Risk Parity Analysis (postgresql)
...
-- Sample data for citadel_positions
...
-- Table: CITIGROUP_INVESTMENT_BANKING
-- ============================================
-- Source: Citigroup Global Investment Banking Analytics (postgresql)
...
-- Sample data for citigroup_investment_banking
...
-- Table: CLIENT_ENGAGEMENTS
-- ============================================
-- Source: McKinsey Client Engagement Analysis (postgresql)
...
-- Sample data for client_engagements
...
-- Table: CORPORATE_RISK_PROFILES
-- ============================================
-- Source: ABN AMRO Corporate Banking Risk Analytics (postgresql)
...
-- Sample data for corporate_risk_profiles
...
-- Table: COSTCO_MEMBERSHIPS
-- ============================================
-- Source: Costco Wholesale Membership Analytics (postgresql)
...
-- Sample data for costco_memberships
...
-- Table: COURSES
-- ============================================
-- Source: Online Learning Platform Analytics (postgresql)
...
-- Table: CREDITSUISSE_MA_DEALS
-- ============================================
-- Source: Credit Suisse Investment Banking M&A (postgresql)
...
-- Sample data for creditsuisse_ma_deals
...
-- Table: CREDITSUISSE_PRIVATE_BANKING
-- ============================================
-- Source: Credit Suisse Private Banking Analytics (postgresql)
...
-- Sample data for creditsuisse_private_banking
...
-- Table: CUSTOMERS
-- ============================================
-- Source: E-commerce Customer Analytics (postgresql)
...
-- Table: DECILE_ANALYSIS
-- ============================================
-- WARNING: No CREATE statement found for decile_analysis
-- This table was referenced but not defined

-- ============================================
-- Table: DELIVERIES
-- ============================================
-- Source: Supply Chain Logistics Analytics (postgresql)
...
-- Sample data for delivery_routes
...
-- Table: DEPARTMENTS
-- ============================================
-- Source: Hospital Patient Care Analytics (postgresql)
...
-- Table: DEUTSCHEBANK_CREDIT_PORTFOLIO
-- ============================================
-- Source: Deutsche Bank Credit Risk Analytics (postgresql)
...
-- Sample data for deutschebank_credit_portfolio
...
-- Table: DIGITAL_METRICS
-- ============================================
-- WARNING: No CREATE statement found for digital_metrics
-- This table was referenced but not defined
...
-- Sample data for distribution_centers
...
-- Table: EFFICIENCY_METRICS
-- ============================================
-- WARNING: No CREATE statement found for efficiency_metrics
-- This table was referenced but not defined

-- ============================================
-- Table: EMPLOYEES
-- ============================================
-- Source: Employee Performance Analytics (postgresql)
...
-- Table: FIDELITY_PORTFOLIO_OPTIMIZATION
-- ============================================
-- Source: Fidelity Investment Portfolio Optimization (postgresql)
...
-- Sample data for fidelity_portfolio_optimization
...
-- Table: GENERATE_SERIES
-- ============================================
-- WARNING: No CREATE statement found for generate_series
-- This table was referenced but not defined

-- ============================================
-- Table: GOLDMANSACHS_ALGO_TRADING
-- ============================================
-- Source: Goldman Sachs Algorithmic Trading Performance (postgresql)
...
-- Sample data for goldmansachs_algo_trading
...
-- Table: GOLDMANSACHS_PRIME_BROKERAGE
-- ============================================
-- Source: Goldman Sachs Prime Brokerage Analytics (postgresql)
...
-- Sample data for goldmansachs_prime_brokerage
...
-- Table: ING_SUSTAINABLE_FINANCE
-- ============================================
-- Source: ING Sustainable Finance Analytics (postgresql)
...
-- Sample data for ing_sustainable_finance
...
-- Table: INTEL_MANUFACTURING
-- ============================================
-- Source: Intel Semiconductor Manufacturing Analytics (postgresql)
...
-- Sample data for intel_manufacturing
...
-- Table: INVENTORY
-- ============================================
-- Source: Inventory Management System (postgresql)
...
-- Table: JPMORGAN_DERIVATIVES
-- ============================================
-- Source: JPMorgan Derivatives Risk Analytics (postgresql)
...
-- Sample data for jpmorgan_derivatives
...
-- Table: LINKEDIN_ENGAGEMENT
-- ============================================
-- Source: LinkedIn Professional Network Analytics (postgresql)
...
-- Sample data for linkedin_engagement
...
-- Table: MA_METRICS
-- ============================================
-- WARNING: No CREATE statement found for ma_metrics
-- This table was referenced but not defined
...
-- Sample data for marketing_channels
...
-- Table: MASTERCARD_NETWORK
-- ============================================
-- Source: Mastercard Global Payment Network Analytics (postgresql)
...
-- Sample data for mastercard_network
...
-- Table: MENU_ITEMS
-- ============================================
-- Source: Restaurant Chain Sales Analysis (postgresql)
...
-- Table: METRICS
-- ============================================
-- WARNING: No CREATE statement found for metrics
-- This table was referenced but not defined

-- ============================================
-- Table: MONTHLY_SPENDING
-- ============================================
-- WARNING: No CREATE statement found for monthly_spending
-- This table was referenced but not defined

-- ============================================
-- Table: MORGANSTANLEY_INSTITUTIONAL_SECURITIES
-- ============================================
-- Source: Morgan Stanley Institutional Securities Analytics (postgresql)
...
-- Sample data for morganstanley_institutional_securities
...
-- Table: MOVIES
-- ============================================
-- Source: Movie Recommendation Engine (postgresql)
CREATE TABLE movies (
          movie_id INT,
          title VARCHAR(100),
          genre VARCHAR(50),
...
-- Table: NEIGHBORHOODS
-- ============================================
-- Source: Real Estate Market Analysis (postgresql)
...
-- Table: NETFLIX_CONTENT_STRATEGY
-- ============================================
-- Source: Netflix Content Strategy Analytics (postgresql)
...
-- Sample data for netflix_content_strategy
...
-- Table: NETWORK_TOWERS
-- ============================================
-- Source: Verizon Network Coverage Analysis (postgresql)
...
-- Sample data for network_towers
...
-- Table: ORACLE_ENTERPRISE_SOFTWARE
-- ============================================
-- Source: Oracle Enterprise Software Analytics (postgresql)
...
-- Sample data for oracle_enterprise_software
...
-- Table: PAYPAL_TRANSACTIONS
-- ============================================
-- Source: PayPal Digital Payments Analytics (postgresql)
...
-- Sample data for performance_metrics
...
-- Table: PINTEREST_CONTENT
-- ============================================
-- Source: Pinterest Content Engagement Analytics (postgresql)
...
-- Sample data for pinterest_content
...
-- Sample data for portfolio_holdings
...
-- Table: PORTFOLIO_METRICS
-- ============================================
-- WARNING: No CREATE statement found for portfolio_metrics
-- This table was referenced but not defined
...
-- Table: POSTS
-- ============================================
-- Source: Social Media Engagement Analysis (postgresql)
CREATE TABLE posts (
...
-- Table: PRODUCTION_LINES
-- ============================================
-- Source: Manufacturing Quality Control Analysis (postgresql)
...
-- Sample data for production_lines
...
-- Sample data for quality_inspections
...
-- Table: RANKED_CUSTOMERS
-- ============================================
-- WARNING: No CREATE statement found for ranked_customers
-- This table was referenced but not defined

-- ============================================
-- Table: RENAISSANCE_STRATEGIES
-- ============================================
-- Source: Renaissance Technologies Quantitative Alpha (postgresql)
...
-- Sample data for renaissance_strategies
...
-- Table: RISK_ANALYSIS
-- ============================================
-- WARNING: No CREATE statement found for risk_analysis
-- This table was referenced but not defined

-- ============================================
-- Table: RISK_CALCULATIONS
-- ============================================
-- WARNING: No CREATE statement found for risk_calculations
-- This table was referenced but not defined

-- ============================================
-- Table: RISK_CONTRIBUTIONS
-- ============================================
-- WARNING: No CREATE statement found for risk_contributions
-- This table was referenced but not defined

-- ============================================
-- Table: RISK_DECILES
-- ============================================
-- WARNING: No CREATE statement found for risk_deciles
-- This table was referenced but not defined
...
-- Table: SALESFORCE_CUSTOMER_SUCCESS
-- ============================================
-- Source: Salesforce Customer Success Analytics (postgresql)
...
-- Sample data for salesforce_customer_success
...
-- Table: SALESFORCE_USAGE
-- ============================================
-- Source: Salesforce CRM Performance Analytics (postgresql)
...
-- Sample data for salesforce_usage
...
-- Table: SCHWAB_WEALTH_MANAGEMENT
-- ============================================
-- Source: Charles Schwab Wealth Management Analytics (postgresql)
...
-- Sample data for schwab_wealth_management
...
-- Table: SECTOR_RISK_METRICS
-- ============================================
-- WARNING: No CREATE statement found for sector_risk_metrics
-- This table was referenced but not defined

-- ============================================
-- Table: SNAPCHAT_ENGAGEMENT
-- ============================================
-- Source: Snapchat Social Media Engagement (postgresql)
...
-- Sample data for snapchat_engagement
...
-- Table: SOLAR_INSTALLATIONS
-- ============================================
-- Source: Energy Consumption Analysis (postgresql)
...
-- Sample data for solar_installations
...
-- Table: STRATEGY_METRICS
-- ============================================
-- WARNING: No CREATE statement found for strategy_metrics
-- This table was referenced but not defined
...
-- Table: SUBSCRIPTION_PLANS
-- ============================================
-- Source: Subscription Business Analytics (postgresql)
...
-- Sample data for subscription_plans
...
-- Table: SUPPORT_AGENTS
-- ============================================
-- Source: Customer Service Analytics Dashboard (postgresql)
...
-- Sample data for support_agents
...
-- Sample data for support_channels
...
-- Sample data for support_tickets
...
-- Table: TARGET_SALES
-- ============================================
-- Source: Target Store Revenue by Category (postgresql)
...
-- Table: TESLA_ENERGY_STORAGE
-- ============================================
-- Source: Tesla Energy Storage Analytics (postgresql)
...
-- Sample data for tesla_energy_storage
...
-- Table: TOTAL_RISK
-- ============================================
-- WARNING: No CREATE statement found for total_risk
-- This table was referenced but not defined

-- ============================================
-- Table: TRADE_TRANSACTIONS
-- ============================================
-- Source: HSBC Trade Finance Analytics (postgresql)
...
-- Sample data for trade_transactions
...
-- Table: TRANSACTIONS
-- ============================================
-- Source: Top Spending Customers by Month (postgresql)
...
-- Table: UBER_MARKET_PERFORMANCE
-- ============================================
-- Source: Uber Ride-Sharing Market Analytics (postgresql)
...
-- Sample data for uber_market_performance
...
-- Table: UBS_PRIVATE_BANKING
-- ============================================
-- Source: UBS Wealth Management Private Banking (postgresql)
...
-- Sample data for ubs_private_banking
...
-- Table: UBS_WEALTH_MANAGEMENT
-- ============================================
-- Source: UBS Wealth Management Analytics (postgresql)
...
-- Sample data for ubs_wealth_management
...
-- Table: UNITEDHEALTH_CLAIMS
-- ============================================
-- Source: UnitedHealth Claims Processing Efficiency (postgresql)
...
-- Sample data for unitedhealth_claims
...
-- Table: USER_SESSIONS
-- ============================================
-- Source: Session Duration Analysis (postgresql)
...
-- Table: VANGUARD_FUNDS
-- ============================================
-- Source: Vanguard Index Fund Performance Analytics (postgresql)
...
-- Sample data for vanguard_funds
...
-- Table: VISA_TRANSACTIONS
-- ============================================
-- Source: Visa Global Payment Processing Analytics (postgresql)
...
-- Sample data for visa_transactions
...
-- Table: WAREHOUSE_INVENTORY
-- ============================================
-- Source: Supply Chain Optimization (postgresql)
...
-- Sample data for warehouse_inventory
...
-- Table: WEALTH_PERFORMANCE
-- ============================================
-- WARNING: No CREATE statement found for wealth_performance
-- This table was referenced but not defined

-- ============================================
-- Table: WELLSFARGO_COMMERCIAL_BANKING
-- ============================================
-- Source: Wells Fargo Commercial Banking Analytics (postgresql)
...
-- Sample data for wellsfargo_commercial_banking
...
-- Table: WF_BORROWERS
-- ============================================
-- Source: Wells Fargo Mortgage Risk Assessment (postgresql)
...
📋 FINAL SUMMARY
===============
✅ Total problems analyzed: 70
✅ Total schemas processed: 70
✅ Unique tables identified: 110
✅ Tables with CREATE statements: 88
✅ Tables with INSERT statements: 88
...
======================================
   ...
   amex_credit_portfolio
   appstore_revenue
   asset_classes
   att_service_calls
   banking_metrics
   banking_performance
   bbva_digital_banking
   blackrock_alternatives
   bnpparibas_investment_banking
   call_stats
   campaign_results
   campaigns
   citadel_positions
   citigroup_investment_banking
   client_engagements
   corporate_risk_profiles
   costco_memberships
   courses
   creditsuisse_ma_deals
   creditsuisse_private_banking
   customers
   decile_analysis
   deliveries
   delivery_routes
   departments
   deutschebank_credit_portfolio
   digital_metrics
   distribution_centers
   efficiency_metrics
   employees
   enrollments
   fidelity_portfolio_optimization
   generate_series
   goldmansachs_algo_trading
   goldmansachs_prime_brokerage
   ing_sustainable_finance
   intel_manufacturing
   inventory
   jpmorgan_derivatives
   linkedin_engagement
   ma_metrics
   marketing_channels
   mastercard_network
   ...
   metrics
   monthly_spending
   morganstanley_institutional_securities
   movies
   neighborhoods
   netflix_content_strategy
   network_towers
   oracle_enterprise_software
   orders
   patients
   paypal_transactions
   performance_metrics
   ...
   risk_deciles
   sales
   salesforce_customer_success
   salesforce_usage
   schwab_wealth_management
   sector_risk_metrics
   snapchat_engagement
   solar_installations
   stores
   ...
   support_tickets
   target_sales
   tesla_energy_storage
   total_risk
   trade_transactions
   transactions
   uber_market_performance
   ubs_private_banking
   ubs_wealth_management
   unitedhealth_claims
   user_sessions
   users
   vanguard_funds
